...
import petrinet.support.IOFiles.ManejadorTXT;
 ...
 public class PetriNet
 {
   ...
   public PetriNet(int[][] _matriz_incidencia, int[][] _marcado_inicial, int[][] _matriz_relacion, int[][] _vector_cotas, int[][] _disparos_automaticos, int[][] _matriz_prioridad)
   {
   ...
   public static PetriNet createPetriNet(String _incidenciaPath, String _marcadoPath, String _relacionPath, String _cotasPath, String _automaticosPath, String _prioridadPath)
   {
     return new PetriNet(ManejadorTXT.getMatrix(_incidenciaPath), ManejadorTXT.getMatrix(_marcadoPath), 
       ...
       ManejadorTXT.getMatrix(_automaticosPath), ManejadorTXT.getMatrix(_prioridadPath));
   }
