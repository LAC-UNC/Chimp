...
/**
 * Empty class, just leave here for historical records just in case in the future this code
 * need to be re-used.
 * 
...
//		processor = (ProcessorHandler) ProcessorHandlerImpl.getInstance(newFilePath,transitionQuantity);
